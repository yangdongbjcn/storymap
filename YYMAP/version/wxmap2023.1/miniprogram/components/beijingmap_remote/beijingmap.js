...
Component({
  ...
  lifetimes: {
    ...
    ready: function () {
      var _this = this
      wx.request({
        url: 'https://www.yd.bj.cn/yd/map/mapdata/china/beijing/beijing.json',//json数据地址
        headers: {
  ...
  methods: {
    ...
    initMychart(dataRegion, dataPoint) {  
      ...
      this.oneComponent.init((canvas, width, height, dpr) => {
        ...
        // echarts.registerMap('reg_map', mapJsonDownload);
        echarts.registerMap('reg_map', this.data.mapJson);
